...
public class PeoplePopulation {
	...
	public final double OUT_CC = 7.720802564 * Math.pow(10, 7);
	public final double GROWTH_RATE = 2.41;
	public final double MIDPOINT = 50;
	...
	// The setters should see no use as they are not how the class is supposed
	// to
	...
	/**
	 * This method has each of the populations grow from what would be
	 * considered natural factors, such as avalibilty of food, avoiding disease,
	 * and having clean vs. unclean air
	 * 
	 * @author Everest Bloomer
	 */
	public void grow(int year) {
		popWCookstove = withCC / (1 + Math.exp((-GROWTH_RATE) * (year - MIDPOINT)));
		popWOut = OUT_CC / (1 + Math.exp((-GROWTH_RATE) * (year - MIDPOINT)));
